        ...
        <div class="table-responsive">
            <form action="{{url('admin/staffupdate')}}/{{$staffs['id']}}" method="GET">
                ...
                <ul style="list-style: none;">
                    <li>氏名</li>
                    <li><input id="name" name="name" type="text" value="{{$staffs['name']}}"></li>
                </ul>

                <ul style="list-style: none;">
                    <li><!-- メモ情報{{$staffs['description']}}--></li>
                    <li>電話</li>
                    <li><input id="tel" name="tel" type="text" value="{{$staffs['tel']}}"></li>
                </ul>

                <ul style="list-style: none;"> 
                    <li>メール</li>
                    <li><input id="email" name="email" type="text" value="{{$staffs['email']}}"></li> 　
                </ul>

                <ul style="list-style: none;">
                    <li>住所</li>
                    <li><input id="address" name="address" type="text" value="{{$staffs['address']}}"></li> 　 
                </ul>

                <ul style="list-style: none;">
                    <li><!-- メモ情報{{$staffs['description']}}--></li>
                    <li>緊急連絡先</li>
                    <li><input id="tel" name="tel2" type="text" value="{{$staffs['tel2']}}"></li>
                </ul>
