...
class SettingController extends Controller
{
	...
	public function time(){
		$shops = new Shops();
		$list['time'] = Settings_time::where('shop_id', $shops->shopId)->get();
	...
	public function timeupdate(){
		...
		$list['tickets'] = Settings_time::where('shop_id', $shops->shopId)->get();
		$list['tickets']->value = $list['time'];
		$list['tickets']->shop_id = $shops->shopId;
		$list['tickets']->create_at = date('Y-m-d H:i:s');
		$list['tickets']->update_at = date('Y-m-d H:i:s');
		$list['tickets']->save();
		return view('admin.setting_time',$list);
	}
