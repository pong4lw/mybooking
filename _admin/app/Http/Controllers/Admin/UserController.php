...
class UserController extends Controller
{
	...
	//	$list['userList'] = Users::all();
		...
		$list['user'] = Users::where('shop_id', $list['adminuser']['shop_id'])->get();
	...
	public function reservation(){
		...
		$list['staffs'] = Staffs::where('shop_id', $list['adminuser']['shop_id'])->get()->name;
	...
	public function userlist(){
		...
		$list['userList'] = Users::where('shop_id', $list['adminuser']['shop_id'])->get();
	...
	public function user($id){
		...
		$list['user'] = $users->where('id',$id)->where('shop_id', $list['adminuser']['shop_id'])->first();
		return view('admin.user',$list);
	}
	...
	public function userupdate($id = null){
		...
		$list['user']['shop_id'] = $list['adminuser']['shop_id'];
