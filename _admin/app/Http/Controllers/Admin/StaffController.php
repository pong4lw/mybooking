...
class StaffController extends Controller
{
	...
	public function stafflist(){
		...
		foreach($list['staffs'] as $k =>$u){
			$list['staffs'][$k]['ticket'] = Tickets::where('client_id', $u['admin_id'])->where('shop_id', $list['adminuser']['shop_id'])->get();
		}
	...
	public function staff($id){
		...
		$list['adminuser'] = Admins::find(Auth::id());
		$list['skill'] = Services::where('shop_id', $list['adminuser']['shop_id'])->get();
  ...
  public function upload(Request $request)
	...
	public function staffupdate($staffs_id = null){
		...
		if($staffs_id == null){
			...
			$list['staffs'] = $staffs->where('id',$staffs_id)->where('shop_id', $list['adminuser']['shop_id'])->first();
		}
		$shop = new Shops();
		$shop_id = $list['adminuser']['shop_id'];
