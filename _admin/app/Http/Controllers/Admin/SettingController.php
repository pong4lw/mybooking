...
class SettingController extends Controller
{
	...
	public function index(){
		...
		$list['week'] = array();
		for( $w = 1; $w <= 7 ; $w++ ){
			$shops = Shops::where('week', '=', $w)->where('shop_id', $list['adminuser']['shop_id'])->first();
			if(is_null($shops)){
				$shops = new Shops();
			}
	...
	public function ticket(){
		...
		$list['tickets'] = Shop_Tickets::where('shop_id', $list['adminuser']['shop_id'])->get();
	...
	public function ticket_delete(){
		...
		$Shop_Tickets = Shop_Tickets::where('shop_id', $list['adminuser']['shop_id'])->where('id', $_GET['id'])->get();
	...
	public function update(){
		...
		for( $w = 1; $w <= 7 ; $w++ ){
			...
			$shops->shop_id = $list['adminuser']['shop_id'];
