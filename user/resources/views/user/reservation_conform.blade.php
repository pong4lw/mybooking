...
<!-- Example DataTables Card-->
    ...
    <ol style="text-align:left;list-style: none;">
        ...
        <li class="item" style="text-align:left;list-style: none;">メニュー</li>
        <li class="item" style="text-align:left;list-style: none;">
    ...
    <li class="item" style="text-align:left;list-style: none;">スタッフ</li>
    <li class="item" style="text-align:left;list-style: none;">     
        <?php foreach($staffs as $k => $v) {?>
            <?php echo $v->name;?><input name="staffs" type="hidden" value="<?php echo $k;?>">
        <?php } ?>
</li>
<li class="item" style="text-align:left;list-style: none;">予約日時</li>
<li class="item" style="text-align:left;list-style: none;"><?php echo $re_date ?? '';?> <?php echo $re_time ?? '';?></li>
<li>
